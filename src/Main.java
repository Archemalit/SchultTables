...
public class Main
{
    ...
    public static String[] menu_choices = new String[] { "1) ???? ???", "2) ???? ??? ????", "3) ???? ???? ????", "4) ???? ?? ????", "5) ???????? ?????", "6) ???? ???"};
    public static String[] menu_choices_two = new String[] {"1) ?", "2) ??"};
    public static String[] menu_choices_three = new String[] { "1) ????", "2) ?????" };

    public static String[] menu_choices_four = new String[] {"1) ???", "2) ??? (? ??? ??? ???? ???? ???? ??? 5 ? 5)"};
